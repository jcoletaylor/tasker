...
ActiveRecord::Schema[7.2].define(version: 20_250_528_143_344) do
  ...
  create_table 'tasker_task_transitions', force: :cascade do |t|
    ...
    t.index %w[task_id most_recent], name: 'index_tasker_task_transitions_on_task_id_and_most_recent', unique: true,
                                     where: '(most_recent = true)'
    t.index %w[task_id sort_key], name: 'index_tasker_task_transitions_on_task_id_and_sort_key', unique: true
  ...
  create_table 'tasker_workflow_step_transitions', force: :cascade do |t|
    ...
    t.index %w[workflow_step_id most_recent], name: 'idx_on_workflow_step_id_most_recent_97d5374ad6', unique: true,
                                              where: '(most_recent = true)'
    t.index %w[workflow_step_id sort_key], name: 'idx_on_workflow_step_id_sort_key_4d476d7adb', unique: true
  ...
  add_foreign_key 'tasker_dependent_system_object_maps', 'tasker_dependent_systems', column: 'dependent_system_one_id',
                                                                                     primary_key: 'dependent_system_id', name: 'dependent_system_object_maps_dependent_system_one_id_foreign'
  add_foreign_key 'tasker_dependent_system_object_maps', 'tasker_dependent_systems', column: 'dependent_system_two_id',
                                                                                     primary_key: 'dependent_system_id', name: 'dependent_system_object_maps_dependent_system_two_id_foreign'
  ...
  add_foreign_key 'tasker_workflow_step_edges', 'tasker_workflow_steps', column: 'from_step_id',
                                                                         primary_key: 'workflow_step_id'
  add_foreign_key 'tasker_workflow_step_edges', 'tasker_workflow_steps', column: 'to_step_id',
                                                                         primary_key: 'workflow_step_id'
  add_foreign_key 'tasker_workflow_step_transitions', 'tasker_workflow_steps', column: 'workflow_step_id',
                                                                               primary_key: 'workflow_step_id'
  add_foreign_key 'tasker_workflow_steps', 'tasker_named_steps', column: 'named_step_id', primary_key: 'named_step_id',
                                                                 name: 'workflow_steps_named_step_id_foreign'
