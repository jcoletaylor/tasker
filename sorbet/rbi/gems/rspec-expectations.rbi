...
class InvalidName___Class_0x00___Differ_21
end
...
class RSpec::Matchers::BuiltIn::Exist::ExistenceTest < Anonymous_Struct_22
...
class RSpec::Matchers::BuiltIn::CaptureStreamToTempfile < Anonymous_Struct_23
